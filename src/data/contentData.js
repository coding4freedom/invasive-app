import pythonImg from '../assets/burmese-python.jpg';
...
const contentData = [
    ...
    },
    {
        ...
        introPara: "Wild hogs commonly slip under the radar of invasive species. Going by many names like feral swine, wild boars and razorbacks. They are spread over many states in the US. Wild hogs causing most damage to Texas, Florida and most southeastern states. Since the wild hog has no natural pedators there population grow exponentially. Sows (female hog) reach adulthood as early as 6 months, with the ability to breed several times a year. Litter size ranging from 4 to 12 piglets.",
        imgUrl: '',
        imgClass: 'hog-img',
        caption: '',
